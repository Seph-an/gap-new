    ...
    <section className="mt-24 py-16 w-screen px-4 sm:px-6 md:px-12 lg:px-20">
      <div className="bg-transparent text-gray-300 container">
        ...
        <p className="mb-6">
          ...
          ("we", "our", or "us"), a licensed recruitment and HR consulting firm
          operating under the Laws of the Republic of Kenya, collects, uses,
          discloses, and protects your personal data. By interacting with our
          services, you consent to the practices described herein.
        </p>
        ...
        <p className="mb-6">
          ...
          . All data processing activities are carried out lawfully, fairly, and
          transparently for legitimate business and operational purposes.
        </p>
        ...
        <p className="mb-6">
          ...
          purposes stated. You may withdraw your consent at any time in writing.
        </p>
        ...
        <p className="mb-6">
          Personal data is retained only for as long as is necessary to fulfill
          the purpose it was collected for or as required by law. When no longer
          needed, data is securely destroyed or anonymized.
        </p>
