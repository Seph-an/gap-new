    ...
    <section className="mt-24 py-16 w-screen px-4 sm:px-6 md:px-12 lg:px-20">
      <div className="bg-transparent text-gray-300 container">
        ...
        <p className="mb-6">
          ...
          website, platforms, and services provided by{" "}
          ...
          platform, you agree to these Terms in full. If you do not accept these
        ...
        <p className="mb-6">
          ...
          limited to, recruitment services, executive search, staff outsourcing,
          payroll processing, job advertisement and listing, employee vetting,
        ...
        <p className="mb-6">
          To use our services, you must be at least 18 years of age or the legal
          working age as defined under Kenyan law. If you are acting on behalf
        ...
        <p className="mb-6">
          ...
          <ul className="list-disc list-inside mt-2">
            ...
            <li>
              Refrain from engaging in fraudulent behavior or misrepresentation.
            </li>
          </ul>
        </p>
        ...
        <p className="mb-6">
          ...
          (Kenya). Any personal or company data collected is processed lawfully,
          transparently, and for a legitimate purpose. Data shared with us
          during recruitment or outsourcing engagements is confidential and
          shall only be used for the intended business transaction unless
        ...
        <p className="mb-6">
          ...
          marks, business methods, original content, and documentation—is owned
          or licensed by the Company. Unauthorized reproduction, use, or
          distribution of any material without prior written consent is strictly
        ...
        <p className="mb-6">
          All payments for recruitment, outsourcing, or consultancy services are
          subject to the terms agreed in official proposals or contracts. Late
          payments may incur penalties. The Company reserves the right to
          withhold services or documentation until all fees are settled in full.
        </p>
        ...
        <p className="mb-6">
          ...
          service engagements by giving written notice, subject to agreed terms
          and notice periods.
        </p>
        ...
        <p className="text-[#51d4d6] font-medium">legal@gaprecruitment.co.ke</p>
      </div>
    </section>
  );
}
