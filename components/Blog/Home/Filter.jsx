...
//   if (isLoading)
//     return <div className="text-[#51D4D6]">Loading categories...</div>;
...
//             !filter ? "bg-[#51D4D6] " : "bg-white/90 shadow-sm"
//           } text-[#1e1e1e] text-sm px-3 py-1`}
//         >
//           All
//         </Link>
...
//Components/Blog/Home/Filter.jsx
// import Link from "next/link";
